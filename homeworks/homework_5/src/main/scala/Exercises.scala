object Exercises {
  ...
  trait Food[T <: Animal] {
    ...
    def feed(animal: T): String =  s"${animal.name} eats ${food_type}"
  }

  case object Meat extends Food[Animal] {
    override val food_type: String = "meat"
  }

  case object Milk extends Food[Cat] {
    override val food_type: String = "milk"
  }

  case object Bread extends Food[Dog] {
    override val food_type: String = "bread"
  }
}
